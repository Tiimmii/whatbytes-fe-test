...
const QuestionAnalysis = () => {
  return (
    <div className='flex flex-col gap-5 border-[1px] border-customBorder rounded-md items-center w-full justify-center p-5'>
      ...
      <p className='text-customText font-medium text-[14px]'><span className='font-bold'>You Scored 10 questions correct out of 15.</span> However it still needs some improvements</p>
    </div>
  )
}
