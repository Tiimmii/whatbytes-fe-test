    ...
    <div className='flex flex-col gap-5 border-[1px] border-customBorder rounded-md items-center w-full justify-center p-7 '>
      ...
      <div className='flex flex-col gap-5 w-full'>
        <div className='flex flex-col gap-2'>
            <p className='text-customText font-medium'>HTML Tools, Forms, History</p>
        ...
        <div className='flex flex-col gap-2'>
            <p className='text-customText font-medium'>Tags & References in HTML</p>
            <div className="flex items-center gap-2">
        ...
        <div className='flex flex-col gap-2'>
            <p className='text-customText font-medium'>Tables & References in HTML</p>
            <div className="flex items-center gap-2">
        ...
        <div className='flex flex-col gap-2'>
            <p className='text-customText font-medium'>Tables & CSS Basics</p>
            <div className="flex items-center gap-2">
