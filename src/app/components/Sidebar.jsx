...
const Sidebar = () => {
  return (
    <div className='sidebar-container border-r-[1px] border-customBorder min-h-full xs:w-12 xs:hover:w-40 sm:w-12 sm:hover:w-40 md:w-40 lg:w-60 lg:hover:w-60 overflow-x-hidden transition duration-300 ease-in-out'>
